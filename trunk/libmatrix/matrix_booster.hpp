...
int naive_multiplymatrix( Complex *,Complex*, Complex *,int,int,int,int,int,int);
int naive_multiplymatrix_openmp( Complex *,Complex *, Complex *,int,int,int,int,int,int);
int blocked_multiplymatrix( Complex *,Complex *, Complex *,int,int,int,int,int,int);
int blocked_multiplymatrix_openmp(Complex *,Complex *, Complex *,int,int,int,int,int,int);

int prueba_int(int,int,int,int,int,int);
int prueba_float(int,int,int,int,int,int);
int prueba_double(int,int,int,int,int,int);
int prueba_Complex(int,int,int,int,int,int);
int prueba_int(int);
int prueba_float(int);
int prueba_double(int);
int prueba_Complex(int);
